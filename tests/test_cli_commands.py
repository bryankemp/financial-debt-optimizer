...
from cli.commands import main, generate_template, analyze, validate, info
...
class TestCLIGenerateTemplate:
    ...
    def test_generate_template_default(self):
        ...
        with self.runner.isolated_filesystem():
            result = self.runner.invoke(generate_template, [
    ...
    def test_generate_template_overwrite_existing(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result2 = self.runner.invoke(generate_template, [
                '--output', str(output_file)
            ], input='y\n')
...
class TestCLIAnalyze:
    ...
    def test_analyze_overwrite_output(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result2 = self.runner.invoke(analyze, [
                '--input', str(self.template_path),
                '--output', str(output_file)
            ], input='y\n')
...
class TestCLIValidate:
    ...
    def setup_method(self):
        ...
        ExcelTemplateGenerator.generate_template(str(self.valid_template_path), include_sample_data=True)
        
        # Create empty template
        self.empty_template_path = self.temp_dir / "empty_template.xlsx"
        ExcelTemplateGenerator.generate_template(str(self.empty_template_path), include_sample_data=False)
...
class TestCLIErrorHandling:
    ...
    def test_generate_template_permission_error(self):
        ...
        with patch('excel_io.excel_reader.ExcelTemplateGenerator.generate_template') as mock_gen:
...
class TestCLIIntegration:
    ...
    def test_cli_error_messages(self):
        ...
        with self.runner.isolated_filesystem():
            ...
            result1 = self.runner.invoke(analyze, [])
            assert result1.exit_code != 0
            assert "Missing option" in result1.output or "required" in result1.output.lower()
