...
class TestExcelTemplateGenerator:
    ...
    def test_generate_template_with_sample_data(self):
        ...
        expected_sheets = ["Debts", "Income", "Recurring Expenses", "Future Income", "Future Expenses", "Settings"]
    ...
    def test_debts_sheet_structure(self):
        ...
        # Check headers
        expected_headers = ["Name", "Balance", "Min Payment", "Interest Rate", "Due Date"]
        ...
        assert isinstance(debts_sheet.cell(row=2, column=2).value, (int, float))  # Balance
    ...
    def test_recurring_expenses_sheet_structure(self):
        ...
        # Check headers
        expected_headers = ["Description", "Amount", "Frequency", "Due Date", "Start Date"]
        for col, expected_header in enumerate(expected_headers, 1):
    ...
    def test_future_income_sheet_structure(self):
        ...
        # Check headers
        expected_headers = ["Description", "Amount", "Start Date", "Frequency", "End Date"]
        for col, expected_header in enumerate(expected_headers, 1):
    ...
    def test_settings_sheet_structure(self):
        ...
        expected_settings = ["Emergency Fund", "Current Bank Balance", "Optimization Goal"]
...
class TestExcelReader:
    ...
    def setup_method(self):
        ...
        ExcelTemplateGenerator.generate_template(str(self.template_path), include_sample_data=True)
    ...
    def test_read_income_sheet(self):
        ...
        for income in income_sources:
            ...
            assert income.frequency in ["weekly", "bi-weekly", "monthly", "quarterly", "annually"]
    ...
    def test_read_recurring_expenses_sheet(self):
        ...
        for expense in expenses:
            ...
            assert expense.frequency in ["bi-weekly", "monthly", "quarterly", "annually"]
    ...
    def test_read_all_data(self):
        ...
        debts, income, expenses, future_income, future_expenses, settings = self.reader.read_all_data()
    ...
    def test_read_empty_template(self):
        ...
        ExcelTemplateGenerator.generate_template(str(empty_template_path), include_sample_data=False)
...
class TestExcelWriter:
    ...
    def test_payment_schedule_sheet_content(self):
        ...
        # Check headers
        expected_headers = ["Month", "Debt Name", "Balance Before", "Interest Charge", 
                          "Principal Payment", "Balance After", "Total Payment"]
        for col, expected_header in enumerate(expected_headers, 1):
        ...
        assert isinstance(schedule_sheet.cell(row=2, column=3).value, (int, float))  # Balance
